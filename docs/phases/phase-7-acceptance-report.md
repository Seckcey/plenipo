...
Test totals: **TOTAL_RUST Rust** (Linux) · **138 frontend** · **39 end-to-end** against the real
...
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| O1  | ADR-013 (how Plenipo lets workers use your computer safely) — **Proposed**. Accepting it means: workers use only Plenipo's own tools, inside their project's folder; sensitive actions always ask (or are blocked); secrets live in Windows Credential Manager, never in Plenipo's files. | Accept, or say what to change.          |
...
| `cargo test --workspace`                                                  | Pass — TOTAL_RUST tests                        |
